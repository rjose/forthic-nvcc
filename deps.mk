...
Ch2Module.o CudaModule.o main.o AddressItem.o Dim3Item.o : CudaModule.h
 DefinitionWord.o Interpreter.o : DefinitionWord.h
Ch2Module.o CudaModule.o Dim3Item.o   : Dim3Item.h
...
Ch2Module.o CudaModule.o DefinitionWord.o EndArrayWord.o GlobalModule.o Interpreter.o PushItemWord.o main.o test/GlobalModuleTest.o test/InterpreterTest.o  : Interpreter.h
Ch2Module.o CudaModule.o GlobalModule.o IntItem.o  : IntItem.h
Ch2Module.o Ch2Module.o CudaModule.o GlobalModule.o Module.o main.o main.o main.o test/GlobalModuleTest.o test/ModuleTest.o AddressItem.o Ch2Module.o CudaModule.o Dim3Item.o FloatItem.o GlobalModule.o IntItem.o Interpreter.o Interpreter.o ModuleItem.o TimePointItem.o : Module.h
