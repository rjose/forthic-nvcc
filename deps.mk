...
DefinitionWord.o EndArrayWord.o GlobalModule.o Interpreter.o PushItemWord.o test/GlobalModuleTest.o test/InterpreterTest.o  : Interpreter.h
GlobalModule.o IntItem.o  : IntItem.h
GlobalModule.o Module.o test/GlobalModuleTest.o test/ModuleTest.o FloatItem.o GlobalModule.o IntItem.o Interpreter.o Interpreter.o ModuleItem.o : Module.h
